...
Public Class ToCategory
    ...
    Private Sub ToCategory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub ButSel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButSel.Click
        Try
            ...
            If Txtcusno.Text <> Nothing And Txtname.Text <> Nothing Then
                searfil = "DESC Like ""%" + Txtname.Text + "%"" and CATEGORY like ""%" + Txtcusno.Text + "%"" "
            ...
            ElseIf Txtcusno.Text <> Nothing And Txtname.Text = Nothing Then
                searfil = "CATEGORY like ""%" + Txtcusno.Text + "%"" "
            End If
            ...
            Frmitmbal.Txttocat.Text = dt.Rows(i)(0)
            Frmitmbal.Btdcat.Enabled = True
            Close()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
