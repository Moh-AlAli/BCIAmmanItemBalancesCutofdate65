...
Public Class FromLocation
    ...
    Private Sub FromLocation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            arv = Frmitmbal.xdbcom.OpenView2("IC0370")
    ...
    Private Sub ButSel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButSel.Click
        Try
            ...
            Frmitmbal.txtfrmloc.Text = dt.Rows(i)(0)
            Frmitmbal.bfdloc.Enabled = True
            Close()
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
